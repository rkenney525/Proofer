...
public enum Rule {
    ...
    public List<Statable> doRule(List<Statable> arg0, List<Statable> arg1, 
        ...
        switch (this) {
            case MP:
                ret = ModusPonens(arg0, arg1, silent);
                break;
            default:
                ret = null;
        }
    ...
    /**
     * Single argument version of doRule().  This function simply calls the
     * two argument version with null passed as the second parameter, but is
